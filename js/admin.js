...
const mostrarProducto = async(imagen) => {
    ...
    response.data.map((producto) =>
        ...
        <tr>
            <th scope="row">${producto.id}</th>
             ...
             <td class="iconos">
              <button class="icono icono-mirar" onClick="mostrarProducto('${producto.imagen}')">
...
document
  .getElementById("guardarProducto").addEventListener("submit", handleClick);
